...
from service.ResearchService import get_research_need_embedding, get_research_need_embedding2, set_research_attr
...
def upload_to_dify(DIFY_TOKEN):
    ...
    files = get_research_need_embedding(start_time=start_time)
